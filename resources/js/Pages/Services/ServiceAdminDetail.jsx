...
import { Paintbrush, ZoomIn, X, Edit2 } from "lucide-react";
import AuthenticatedLayout from "@/Layouts/AuthenticatedLayout";

export default function ServiceAdminDetail({
    service,
    additionalTypes,
    completedPhotos,
}) {
                        ...
                        <div className="bg-white shadow-lg rounded-xl overflow-hidden border border-gray-200 p-6">
                            ...
                            <div className="flex flex-col sm:flex-row justify-end gap-4 mb-6">
                                <Link
                                    ...
                                    className="bg-gradient-to-r from-blue-500 to-blue-700 text-white px-6 py-2 rounded-lg hover:from-blue-600 hover:to-blue-800 transition-all duration-300 text-center flex items-center gap-2"
                                >
